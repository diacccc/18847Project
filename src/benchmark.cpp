...
std::vector<BenchmarkResult> GemmBenchmark::runAll() {
    ...
    for (const auto& size : matrix_sizes_) {
        ...
        for (const auto& impl : implementations_) {
            ...
            // Run the benchmark
            BenchmarkResult result = benchmarkImplementation(
                impl.get(), A, B, C, ref_result.get()
            );
...
void registerImplementations() {
    ...
    registerImplementation("BLAS", []() -> GemmImplementation* {
        return new GemmBLAS();
    });
    ...
    registerImplementation("cpu_omp", []() -> GemmImplementation* {
        return new GemmOMP();
    });
